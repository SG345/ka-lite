...
class OnlineTests(LiveServerTestCase):
    ...
    def test_am_online(self):
        ...
        self.assertFalse(am_i_online("http://this.server.should.never.exist.or.else.we.are.screwed/",
        ...
        # search_string
        self.assertTrue(am_i_online(self.live_server_url, search_string="KA Lite",
